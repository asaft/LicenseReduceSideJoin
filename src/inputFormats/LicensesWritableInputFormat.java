...
public class LicensesWritableInputFormat extends FileInputFormat<Text,LicenseWritable> {
	...
	protected class LicenseWritableRecordReader extends RecordReader<Text, LicenseWritable>{
		...
		public void initialize(InputSplit split, TaskAttemptContext context)
	        ...
	        _currentValue = new LicenseTypeWritable();
	        _currentValue.set_parsingStrategy(getParsingStrategy(ILicenseTypeParsingStrategy.class));
	        _in = fs.open(_file);
